...
struct NotchIslandContent: View {
    ...
    private var pill: some View {
        ...
        .shadow(color: pillFlashing ? Color.green.opacity(0.6) :
                        (hasWorking ? pillTint.opacity(0.5) : Color.black.opacity(0.35)),
                radius: pillFlashing ? 22 : (hasWorking ? 16 : 12), x: 0, y: 6)
        .animation(.easeInOut(duration: 0.25), value: pillFlashing)
